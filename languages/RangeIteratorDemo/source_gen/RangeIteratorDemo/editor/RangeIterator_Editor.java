package RangeIteratorDemo.editor;
...
public class RangeIterator_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_amkjio_a(editorContext, node);
  }

  private EditorCell createCollection_amkjio_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_amkjio_a");
    editorCell.addEditorCell(this.createRefNode_amkjio_a0(editorContext, node));
